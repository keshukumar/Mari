...
public class PendingCreditsAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    @LayoutRes
    Integer resId = R.layout.inflator_pending_credits;
    ...
    public PendingCreditsAdapter(Context context, List<T> ts) {
        this.ts = ts;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private void bindWith(int position) {
            ...
            // set views data here
            if (ts.get(position) instanceof PendingCredits) {
                PendingCredits pendingCredits = (PendingCredits) ts.get(position);
                tv_trader_name.setText(pendingCredits.getTraderName());
            }
        }
        ...
        public void onClick(View v) {
            ...
            PendingCredits request = (PendingCredits) ts.get(position);
            switch (v.getId()) {
