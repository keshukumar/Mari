...
import com.example.marikiti.activity.Add_Sub_Shop_Activity;
...
public class shop_list_adapter extends RecyclerView.Adapter<shop_list_adapter.ViewHolder> {
    ...
    public shop_list_adapter(List<shop_list_model> addShop_models, Context context) {
        this.addShop_models = addShop_models;
        this.context = context;
    }

    public shop_list_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.shops_list_layout, viewGroup, false);
        return new shop_list_adapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final shop_list_adapter.ViewHolder viewHolder, int i) {
        ...
        viewHolder.Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (addShop_model.getOther_shop_id().equals("21")) {

                    context.startActivity(new Intent(context, Add_Sub_Shop_Activity.class)
                            .putExtra("id", addShop_model.getOther_shop_id())
                            .putExtra("name",addShop_model.getOther_shop_name()));
                } else
                {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, ADD_SHOP, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Log.d("response",traders_id+"\n"+addShop_model.getOther_shop_id()+"\n"+response);
