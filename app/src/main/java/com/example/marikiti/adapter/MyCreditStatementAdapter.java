...
import com.example.marikiti.model.MyCreditStatement;
...
public class MyCreditStatementAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    @LayoutRes
    Integer resId = R.layout.inflator_my_credit_statement;
    ...
    public MyCreditStatementAdapter(Context context, List<T> ts) {
        this.ts = ts;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private void bindWith(int position) {
            ...
            // set views data here
            if (ts.get(position) instanceof MyCreditStatement) {
                MyCreditStatement myCreditStatement = (MyCreditStatement) ts.get(position);
                tv_trader_name.setText(myCreditStatement.getTraderName());
            }
        }
        ...
        public void onClick(View v) {
            ...
            MyCreditStatement request = (MyCreditStatement) ts.get(position);
            switch (v.getId()) {
