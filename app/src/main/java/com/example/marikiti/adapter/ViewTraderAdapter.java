...
public class ViewTraderAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    @LayoutRes
    Integer resId = R.layout.inflator_view_trader;
    ...
    public ViewTraderAdapter(Context context, List<T> ts) {
        this.ts = ts;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private GTextView tv_trader_name, tv_mobile, tv_trader_code, tv_view;
        ...
        private void bindWith(int position) {
            ...
            // set views data here
            if (ts.get(position) instanceof ViewTrader) {
                ViewTrader viewTrader = (ViewTrader) ts.get(position);
                tv_trader_name.setText(viewTrader.getName());
            }
        }
        ...
        public void onClick(View v) {
            ...
            ViewTrader request = (ViewTrader) ts.get(position);
            switch (v.getId()) {
                case R.id.tv_mobile:
