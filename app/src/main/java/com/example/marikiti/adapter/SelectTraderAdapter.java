...
public class SelectTraderAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    @LayoutRes
    Integer resId = R.layout.inflator_select_trader;
    ...
    public SelectTraderAdapter(Context context, List<T> ts) {
        this.ts = ts;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private void bindWith(int position) {
            ...
            if (ts.get(position) instanceof SelectTrader) {
                SelectTrader selectTrader = (SelectTrader) ts.get(position);
                tv_trader_name.setText(selectTrader.getName());
            }
        }
        ...
        public void onClick(View v) {
            ...
            SelectTrader request = (SelectTrader) ts.get(position);
            switch (v.getId()) {
                case R.id.tv_mobile:
