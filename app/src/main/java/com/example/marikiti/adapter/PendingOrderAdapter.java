...
public class PendingOrderAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    @LayoutRes
    Integer resId = R.layout.inflator_pending_order;
    ...
    public PendingOrderAdapter(Context context, List<T> ts) {
        this.ts = ts;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private void bindWith(int position) {
            ...
            // set views data here
            if (ts.get(position) instanceof PendingOrder) {
                PendingOrder pendingOrder = (PendingOrder) ts.get(position);
                tv_trader_name.setText(pendingOrder.getTraderName());
            }
        }
        ...
        public void onClick(View v) {
            ...
            PendingOrder request = (PendingOrder) ts.get(position);
            switch (v.getId()) {
