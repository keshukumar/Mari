...
import com.example.marikiti.app.App;
...
public class DialogForgetPassword {
    ...
    public static void openDialog(final Context mContext) {
        DialogForgetPassword.mContext = mContext;
        LayoutInflater inflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        final View view = inflater.inflate(R.layout.dialog_forgot_password, null);
        Holder.et_email = (EditText) view.findViewById(R.id.et_email_address);
        Holder.et_email.setText(AppPrefs.getString(App.Key.USER_EMAIL));
    ...
    static View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.btn_ok:
                    if (ViewUtils.isEditTextValid(Holder.et_email, "Required")) {
                        forgotPass();
                    }
