...
public class HealthAndBeautyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private ImageView img_fruits, img_vegetables, img_cereals,img_butchery,img_dairy,img_fishseafood,
            img_readymeals,img_bakery,img_papa_jo_pizza;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.mContext = this;
        setContentView(R.layout.activity_health_beauty);
        initToolbar();
        findViewID();
    }
