...
public class EditBusinessLocationActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.mContext = this;
        setContentView(R.layout.activity_edit_b_location);
        initToolbar();
        findViewID();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_save:
                Intent save = new Intent(mContext, HomeActivity.class);
                startActivity(save);
                finish();
                break;
