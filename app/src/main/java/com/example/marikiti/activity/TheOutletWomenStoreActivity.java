...
public class TheOutletWomenStoreActivity extends BaseActivity implements View.OnClickListener {
...
Title model=new Title();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.mContext = this;
        setContentView(R.layout.activity_the_outlet_women_store);
        initToolbar();
        findViewID();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.img_fishseafood:
                ...
                model.setTitle("Women’s Lingerie");
            ...
            case R.id.img_health_beauty:
                ...
                model.setTitle("Women’s Trousers");
