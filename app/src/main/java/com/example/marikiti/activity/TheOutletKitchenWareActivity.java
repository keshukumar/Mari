...
public class TheOutletKitchenWareActivity extends BaseActivity implements View.OnClickListener {
...
Title model=new Title();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.mContext = this;
        setContentView(R.layout.activity_the_outlet_kitchen_ware);
        initToolbar();
        findViewID();
    }
