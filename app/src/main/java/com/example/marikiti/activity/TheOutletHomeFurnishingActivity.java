...
public class TheOutletHomeFurnishingActivity extends BaseActivity implements View.OnClickListener {
...
Title model=new Title();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.mContext = this;
        setContentView(R.layout.activity_the_outlet_home_furnishing);
        initToolbar();
        findViewID();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.img_readymeals:
                ...
                model.setTitle("Garden Furniture");
            ...
            case R.id.img_bakery:
                ...
                model.setTitle("Pots and Plants");
