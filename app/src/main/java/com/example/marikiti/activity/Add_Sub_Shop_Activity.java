...
import com.example.marikiti.adapter.Add_Sub_Shop_Adapter;
...
public class Add_Sub_Shop_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add__sub__shop_);
        try {
        ...
        adapter = new Add_Sub_Shop_Adapter(addShop_models, Add_Sub_Shop_Activity.this);
    ...
    private void fetchList() {
        ...
        final ProgressDialog load=ProgressDialog.show(Add_Sub_Shop_Activity.this,"Loading..","Please Wait",false,false);
