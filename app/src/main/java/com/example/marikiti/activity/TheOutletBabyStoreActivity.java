...
public class TheOutletBabyStoreActivity extends BaseActivity implements View.OnClickListener {
...
Title model=new Title();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.mContext = this;
        setContentView(R.layout.activity_the_outlet_baby_store);
        initToolbar();
        findViewID();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.img_fishseafood:
                ...
                model.setTitle("Feeding Bottles");
