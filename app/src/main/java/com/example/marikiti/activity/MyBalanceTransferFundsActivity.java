...
public class MyBalanceTransferFundsActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.mContext = this;
        setContentView(R.layout.activity_my_balance_transfer_funds);
        initToolbar();
        findViewID();
    }
