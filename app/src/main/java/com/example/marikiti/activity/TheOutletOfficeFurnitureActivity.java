...
public class TheOutletOfficeFurnitureActivity extends BaseActivity implements View.OnClickListener {
...
Title model=new Title();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.mContext = this;
        setContentView(R.layout.activity_the_outlet_office_furniture);
        initToolbar();
        findViewID();
    }
    ...
    private void initToolbar() {
        ...
        title.setText("Office Furnishing ");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.img_dairy:
                ...
                model.setTitle("Executive Chairs");
                startActivity(dairy);
                break;
            case R.id.img_fishseafood:
                ...
                model.setTitle("High Back Chairs");
            ...
            case R.id.img_readymeals:
                ...
                model.setTitle("Operator Chairs");
            ...
            case R.id.img_bakery:
                ...
                model.setTitle("Reception Chairs");
            ...
            case R.id.img_papa_jo_pizza:
                ...
                model.setTitle("Reception Counters");
