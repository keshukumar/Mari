...
public class MassaiMarketActivity extends AppCompatActivity implements View.OnClickListener {
...
Title model=new Title();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mContext = this;
        setContentView(R.layout.activity_massai_market);
        initToolbar();
        findViewID();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.img_bakery:
                ...
                model.setTitle("Women’s Clothes");
